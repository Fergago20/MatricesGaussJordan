...
class AppGaussJordan(tk.Toplevel):
    """Pantalla del método de Gauss-Jordan (RREF). Procedimiento: SOLO matrices."""
    ...
    def __init__(self, toplevel_parent=None, on_volver=None):
        ...
        self._on_volver = on_volver  # (opcional para botón volver)
        ...
        # IMPORTANTE: X cierra toda la app
    ...
    def _construir_ui(self):
        ...
        self.lista_sistema = tk.Listbox(marco_sis, width=48, height=18, bg="#161616",
                                        fg=texto, selectbackground="#2f2f2f")
